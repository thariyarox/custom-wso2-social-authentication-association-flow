...
<%!
    ...
    private static final String FB_SOCIAL_AUTHENTICATOR = "FBSocialAuthenticator";
                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                    ...
                    <div class="boarder-all ">
                        ...
                        <div class="padding-double login-form">
                            ...
                            <%
                            } else if (localAuthenticatorNames.size() > 0 && localAuthenticatorNames.contains(FB_SOCIAL_AUTHENTICATOR)) {
                                hasLocalLoginOptions = true;
                            %>
                                    ...
                                    <a href="#" data-toggle="popover" data-placement="bottom"
                                       ...
                                       id="icon-<%=iconId%>">
                                        ...
                                        <div id="popover-head" class="hide">
                                            <label class="font-large">Sign in with <%=Encode.forHtmlContent(idpName)%>
                                            </label>
                                        </div>
